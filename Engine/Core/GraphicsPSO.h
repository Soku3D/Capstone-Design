...
namespace soku {
	...
	public:
		...
		void SetVertexShader(const void* Binary, size_t Size, Microsoft::WRL::ComPtr<ID3D11Device>& device){
			device->CreateVertexShader(Binary, Size, nullptr, m_PSODesc.m_vertexShader.GetAddressOf());
		}
		void SetPixelShader(const void* Binary, size_t Size, Microsoft::WRL::ComPtr<ID3D11Device>& device) {
			device->CreatePixelShader(Binary, Size, nullptr, m_PSODesc.m_pixelShader.GetAddressOf());
		}
